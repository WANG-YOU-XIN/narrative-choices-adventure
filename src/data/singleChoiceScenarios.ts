...
export interface SingleChoiceScenario {
  id: string;
  text: string;
  age?: number;
  effect?: {
...
// Move all single-choice scenarios here
export const singleChoiceScenarios: Record<number, SingleChoiceScenario[]> = {
  2: [
    {
      id: 'age_2_agility',
...
// Function to get a random single-choice scenario for a specific age
export const getRandomSingleChoiceScenario = (age: number): SingleChoiceScenario | null => {
  const scenariosForAge = singleChoiceScenarios[age] || [];
